  ...
  return (
    <main className="my-12 w-full p-8 lg:w-[55%]">
      <section className="flex justify-between gap-4">
        <div>
          ...
          <p className="text-balance text-lg text-gray-700 dark:text-gray-300">
            <strong>To Build is To Live</strong>. Clean code, smooth UX, and constant growth — that’s how I build for the web.
          </p>
        </div>
        <Image
          src="/me.png"
      ...
      <section className="mt-4">
        ...
        <p className="text-justify text-base text-gray-700 dark:text-gray-300">
